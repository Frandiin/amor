          ...
          {isMenuOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="#services" className="block text-white hover:text-yellow-500 py-2">Services</a>
                <a href="#about" className="block text-white hover:text-yellow-500 py-2">About</a>
                <a href="#plans" className="block text-white hover:text-yellow-500 py-2">Plans</a>
                <a href="#contact" className="block text-white hover:text-yellow-500 py-2">Contact</a>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-center md:text-left md:max-w-2xl">
            ...
            <p className="mt-3 text-base text-gray-100 sm:text-lg md:mt-5 md:text-xl">
              Specialized personal trainer focused on real results. Customized training for your specific goals.
            </p>
            ...
            {[
              {
                ...
                description: "Exclusive programs designed for your specific goals."
              },
              {
              ...
              },
              {
                ...
                description: "Ongoing support and adjustments to your training program."
              }
            ].map((item, index) => (
              <div key={index} className="flex flex-col items-center bg-gray-800 p-6 rounded-lg">
          ...
          <div className="lg:text-center">
            ...
            <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-8">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-400 lg:mx-auto">
                With over 10 years of experience, I specialize in physical transformation and well-being. 
                My approach combines effective workouts, proper nutrition, and constant support 
            ...
            {[
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="mt-4 text-4xl font-bold">{plan.price}<span className="text-sm">/month</span></p>
            ...
            {[
              {
                ...
                after: "https://images.unsplash.com/photo-1571019613576-2b22c76fd955",
                name: "Carlos Silva",
                result: "-33 lbs in 3 months"
              },
              {
                before: "https://images.unsplash.com/photo-1571019613576-2b22c76fd955",
              ...
              <div key={index} className="bg-gray-800 rounded-lg overflow-hidden">
                <div className="relative">
                  <div className="aspect-w-16 aspect-h-9">
                    <img src={transformation.after} alt="After" className="object-cover" />
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black">
                    <p className="text-white font-bold">{transformation.name}</p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "If you don't see results in 30 days, we refund your money"
              }
            ].map((benefit, index) => (
              <div key={index} className="bg-gray-800 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-yellow-500">{benefit.title}</h3>
            ...
            {[
              {
                ...
                testimonial: "Best decision I ever made! In 3 months, I saw incredible results. The support is phenomenal!",
                age: "32 years old"
              },
              {
                name: "Roberto Gomes",
                photo: "https://images.unsplash.com/photo-1571019613576-2b22c76fd955",
                testimonial: "Workouts that fit my busy schedule. Surprising results even with limited time.",
                age: "45 years old"
              },
              {
                name: "Juliana Costa",
                photo: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b",
                testimonial: "Nutrition consulting made all the difference. I lost weight and gained so much energy!",
                age: "28 years old"
              }
            ...
            {[
              {
                ...
                answer: "With dedication and following the plan, initial results are visible in 30 days. More significant results in 90 days."
              },
              {
                question: "Do I need prior experience with exercise?",
                answer: "No! Our approach is tailored for all levels, from beginners to advanced."
              },
              {
                question: "How does online coaching work?",
                answer: "You'll have access to an exclusive app, detailed exercise videos, and daily WhatsApp support."
              },
              {
                question: "What if I have an injury or limitation?",
                answer: "We conduct a full assessment and adapt exercises to your specific conditions."
              }
            ].map((faq, index) => (
              <div key={index} className="mt-8 border-b border-gray-800">
                <div className="mb-4">
                  <h3 className="text-lg font-medium text-yellow-500">{faq.question}</h3>
